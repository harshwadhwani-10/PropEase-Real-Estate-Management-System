...
const seedDatabase = async () => {
  try {
    ...
    // Create 8 Owners for Gujarat properties
    const owners = [];
    const ownerData = [
      {
    ...
    // Create 30 listings across Gujarat
    const allListings = [];

    // Helper function to get random city
    const getRandomCity = () => gujaratCities[Math.floor(Math.random() * gujaratCities.length)];
    ...
    // Owner 1: Patel Properties - Ahmedabad & Gandhinagar (4 listings)
    ...
    allListings.push(
      {
        ...
        location: {
          type: "Point",
          coordinates: [addVariation(72.5714, 0.05), addVariation(23.0225, 0.05)], // [lng, lat]
        },
        imageUrls: [
    ...
    // Owner 2: Shah Realty - Surat & Vadodara (4 listings)
    ...
    // Owner 3: Desai Homes - Rajkot & Jamnagar (4 listings)
    ...
    allListings.push(
      ...
      },
      {
        ...
        description: "Luxurious 5-bedroom bungalow in Bedi area. Grand architecture, 5 bathrooms, large living spaces, modern kitchen, home theater, and landscaped garden. Perfect for large families. Near Marine National Park and beaches.",
    ...
    // Owner 4: Mehta Properties - Bhavnagar & Anand (4 listings)
    const city4 = getRandomCity();
    allListings.push(
      {
    ...
    // Owner 5: Jain Estates - Mehsana & Bharuch (4 listings)
    const city5 = getRandomCity();
    allListings.push(
      {
    ...
    // Owner 6: Gujarati Homes - Navsari & Junagadh (4 listings)
    const city6 = getRandomCity();
    allListings.push(
      {
    ...
    // Owner 7: Amdavad Properties - Ahmedabad & Gandhinagar (5 listings)
    const city7 = getRandomCity();
    allListings.push(
      {
    ...
    // Owner 8: Surat Realty - Surat & Vadodara (5 listings)
    const city8 = getRandomCity();
    allListings.push(
      {
    ...
    insertedListings.forEach(listing => {
      // Extract city from address (rough estimate)
    ...
    console.log("📍 All properties are located in Gujarat, India");
