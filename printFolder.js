...
const IGNORED_FOLDERS = new Set(['node_modules', 'public', '.git', '.vscode', 'assets', '.husky', '.next', '.angular', 'android', 'ios', 'build']);
const MAX_ITEMS_PER_FOLDER = 1200;

/**
 * Prints the directory tree with correct formatting and relative paths.
 * @param {string} dirPath - Current directory to list.
 * @param {string} prefix - Prefix for formatting tree branches.
 */
...
/**
 * Entry point — starts at the current directory
 */
